...
#include "ui/jerror.h"		/* get library error codes too */
#include "ui/cderror.h"		/* get application-specific error codes */
...
typedef struct jpeg_fl_data *jpeg_file_data;
