...
#define os_time_before(a, b) \
	((unsigned)(a)->sec < (unsigned)(b)->sec || \
	 ((a)->sec == (b)->sec && (unsigned)(a)->usec < (unsigned)(b)->usec))

#define os_time_sub(a, b, res) do { \
	(res)->sec = (unsigned)((a)->sec) - (unsigned)((b)->sec); \
	(res)->usec = (unsigned)((a)->usec) - (unsigned)((b)->usec); \
	if ((res)->usec < 0) { \
		(res)->sec--; \
		(res)->usec += 1000000; \
	} \
...
#define os_strcasecmp strcmp
#define os_strncasecmp strncmp
