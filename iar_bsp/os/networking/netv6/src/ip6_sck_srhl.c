...
*       socket option to return the Hop Limit of the most recently
...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets the socket option to return the hop limit 
...
*                                                                       
*************************************************************************/
STATUS IP6_Set_IPV6_RECVHOPLIMIT(INT socketd, INT optval)
{
    ...
    if (sck_ptr->s_protocol != NU_PROTO_TCP)
    {
        ...
        if (optval)
            sck_ptr->s_options |= SO_IPV6_HOPLIMIT_OP;
