...
*       NU_Setsockopt_IPV6_RECVHOPLIMIT.
*
*   DATA STRUCTURES
*
*       None.
...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets the socket option to return the hop limit of 
...
*                                                                         
*************************************************************************/
STATUS NU_Setsockopt_IPV6_RECVHOPLIMIT(INT socketd, INT optval)
{
    STATUS  status;
    ...
    {
        status = IP6_Set_IPV6_RECVHOPLIMIT(socketd, optval);
