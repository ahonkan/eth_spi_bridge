...
*       return the hop-by-hop options of the most recently received IPv6 
*       packet on a socket.
*                                                                          
*   DATA STRUCTURES                                                          
*                      
...
*                                                                       
*************************************************************************/
STATUS IP6_Get_IPV6_RECVHOPOPTS(INT socketd, INT *optval, INT *optlen)
{
    *optlen = sizeof(INT);

    if (SCK_Sockets[socketd]->s_options & SO_IPV6_HOPOPTS)
        *optval = 1;
    else
        *optval = 0;
