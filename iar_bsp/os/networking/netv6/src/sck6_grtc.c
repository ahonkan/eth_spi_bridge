...
*       enabling or disabling the socket option to return the traffic 
*       class of the most recently received IPv6 packet on a socket.
*                                                                         
*   INPUTS                                                                
*                                                                         
...
*                                                                         
*************************************************************************/
STATUS NU_Getsockopt_IPV6_RECVTCLASS(INT socketd, INT *optval, INT *optlen)
{
    STATUS  status;
    ...
    else
    {
        ...
        {
            status = IP6_Get_IPV6_RECVTCLASS(socketd, optval, optlen);
