...
*       NU_Getsockopt_IPV6_RECVHOPLIMIT.
*
*   DATA STRUCTURES
*
*       None.
...
*                                                                         
*************************************************************************/
STATUS NU_Getsockopt_IPV6_RECVHOPLIMIT(INT socketd, INT *optval, INT *optlen)
{
    STATUS  status;
    ...
    else
    {
        ...
        {
            status = IP6_Get_IPV6_RECVHOPLIMIT(socketd, optval, optlen);
