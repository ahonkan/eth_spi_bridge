...
*       socket option to return the destination options of the most 
*       recently received IPv6 packet on a socket.
*                                                                          
*   DATA STRUCTURES                                                          
*                      
*       None                
...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets the socket option to return the destination
...
*                                                                       
*************************************************************************/
STATUS IP6_Set_IPV6_RECVDSTOPTS(INT socketd, INT optval)
{
    ...
    if (sck_ptr->s_protocol != NU_PROTO_TCP)
    {
        ...
        if (optval)
            sck_ptr->s_options |= SO_IPV6_DESTOPTS;
