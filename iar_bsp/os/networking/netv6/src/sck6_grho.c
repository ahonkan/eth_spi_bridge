...
*       NU_Getsockopt_IPV6_RECVHOPOPTS.
*
*   DATA STRUCTURES
*
*       None.
...
*       enabling or disabling the socket option to return the hop-by-hop
...
*                                                                         
*************************************************************************/
STATUS NU_Getsockopt_IPV6_RECVHOPOPTS(INT socketd, INT *optval, INT *optlen)
{
    STATUS  status;
    ...
    else
    {
        ...
        {
            status = IP6_Get_IPV6_RECVHOPOPTS(socketd, optval, optlen);
