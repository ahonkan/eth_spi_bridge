...
*       socket option to return the hop-by-hop options of the most 
...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets the socket option to return the hop-by-hop
...
*                                                                       
*************************************************************************/
STATUS IP6_Set_IPV6_RECVHOPOPTS(INT socketd, INT optval)
{
    ...
    if (sck_ptr->s_protocol != NU_PROTO_TCP)
    {
        ...
        if (optval)
            sck_ptr->s_options |= SO_IPV6_HOPOPTS;
