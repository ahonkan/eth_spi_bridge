...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets a destination option Sticky Option for a socket.
*                                                                         
*   INPUTS                                                                
*                                                                         
...
*                                                                       
*************************************************************************/
STATUS IP6_Set_IPV6_DSTOPTS(INT socketd, const struct ip6_dest *dst_hdr, 
                            INT length)
{
