...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets the socket option to return the traffic class 
...
*                                                                         
*************************************************************************/
STATUS NU_Setsockopt_IPV6_RECVTCLASS(INT socketd, INT optval)
{
    STATUS  status;
    ...
    {
        status = IP6_Set_IPV6_RECVTCLASS(socketd, optval);
