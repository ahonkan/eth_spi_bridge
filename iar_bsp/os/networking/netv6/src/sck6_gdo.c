...
*       NU_INVAL                Either dst_hdr or optlen are invalid.
*                                                                         
*************************************************************************/
STATUS NU_Getsockopt_IPV6_DSTOPTS(INT socketd, struct ip6_dest *dst_hdr,
                                  INT *optlen)
{
    STATUS  status;
    ...
    else
    {
        ...
        {
            status = IP6_Get_IPV6_DSTOPTS(socketd, dst_hdr, optlen);
