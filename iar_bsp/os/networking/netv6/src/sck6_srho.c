...
*       NU_Setsockopt_IPV6_RECVHOPOPTS.
*
*   DATA STRUCTURES
*
*       None.
...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets the socket option to return all hop-by-hop 
...
*                                                                         
*************************************************************************/
STATUS NU_Setsockopt_IPV6_RECVHOPOPTS(INT socketd, INT optval)
{
    STATUS  status;
    ...
    {
        status = IP6_Set_IPV6_RECVHOPOPTS(socketd, optval);
