...
*       NU_Getsockopt_IPV6_RECVPKTINFO.
*
*   DATA STRUCTURES
*
*       None.
...
*                                                                         
*************************************************************************/
STATUS NU_Getsockopt_IPV6_RECVPKTINFO(INT socketd, INT *optval, INT *optlen)
{
    STATUS  status;
    ...
    else
    {
        ...
        {
            status = IP6_Get_IPV6_RECVPKTINFO(socketd, optval, optlen);
