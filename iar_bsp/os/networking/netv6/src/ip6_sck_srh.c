...
*   DESCRIPTION                                                           
*                                                                         
*       This function sets a routing header Sticky Option for a socket.
*                                                                         
*   INPUTS                                                                
*                                                                         
*       socketd                 Specifies a socket descriptor
*       *rt_hdr                 A pointer to the routing header.
...
*                                                                       
*************************************************************************/
STATUS IP6_Set_IPV6_RTHDR(INT socketd, const struct ip6_rthdr *rt_hdr, 
                          INT length)
{
    ...
    if (data_ptr)
        return_status = SCK_Set_TX_Sticky_Options(data_ptr, (VOID*)rt_hdr, 
                                                  length, IPV6_RTHDR);
    else
