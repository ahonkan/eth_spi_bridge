...
and [options] can be one of
	...
	no-ripemd
	no-rc2 no-arc4 no-rc5 no-idea no-des     - Skip this symetric cipher
...
$cflags.=" -DOPENSSL_NO_ARC4"  if $no_arc4;
...
sub read_options
	...
	my %valid_options = (
		...
		"no-patents" => 
			[\$no_rc2, \$no_arc4, \$no_rc5, \$no_idea, \$no_rsa],
		"no-rsa" => \$no_rsa,
		"no-dsa" => \$no_dsa,
		"no-dh" => \$no_dh,
		"no-hmac" => \$no_hmac,
