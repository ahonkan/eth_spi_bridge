...
my @known_algorithms = ( "RC2", "ARC4", "RC5", "IDEA", "DES", "BF",
...
my $no_rc2; my $no_arc4; my $no_rc5; my $no_idea; my $no_des; my $no_bf;
...
$crypto.=" crypto/arc4/arc4.h" ; # unless $no_arc4;
...
sub is_valid
{
	...
	sub recognise
	{
		...
		if ($platforms) {
			...
			if ($keyword eq "ARC4" && $no_arc4) { return 0; }
