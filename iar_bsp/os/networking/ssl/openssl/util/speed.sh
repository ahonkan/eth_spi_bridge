...
/bin/rm -f crypto/arc4/*.o crypto/bn/bn*.o crypto/md2/md2_dgst.o
make
apps/ssleay speed arc4 rsa md2 >speed.2l

perl Configure bl-4c-ri
/bin/rm -f crypto/arc4/arc4*.o
make
apps/ssleay speed arc4 >speed.3l

perl Configure b2-is-ri-dp
/bin/rm -f crypto/idea/i_*.o crypto/arc4/*.o crypto/des/ecb_enc.o crypto/bn/bn*.o
apps/ssleay speed rsa arc4 idea des >speed.4l
