...
$!
$   WRITE H_FILE "#if defined(HEADER_ARC4_H)"
$   WRITE H_FILE "#undef ARC4_INT"
$   WRITE H_FILE "#define ARC4_INT unsigned int"
$   WRITE H_FILE "#undef ARC4_CHUNK"
$   WRITE H_FILE "#define ARC4_CHUNK unsigned long long"
$   WRITE H_FILE "#endif"
$!
...
$   WRITE H_FILE "#if defined(HEADER_ARC4_H)"
$   WRITE H_FILE "#undef ARC4_INT"
$   WRITE H_FILE "#define ARC4_INT unsigned char"
$   WRITE H_FILE "#undef ARC4_CHUNK"
$   WRITE H_FILE "#define ARC4_CHUNK unsigned long"
$   WRITE H_FILE "#endif"
$!
$   WRITE H_FILE "#if defined(HEADER_DES_LOCL_H)"
$   WRITE H_FILE "#undef DES_LONG"
...
$ SDIRS := ,-
   ...
   DES,AES,RC2,ARC4,RC5,IDEA,BF,CAST,CAMELLIA,SEED,MODES,-
