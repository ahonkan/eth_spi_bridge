...
/*
 * Functions for Cipher (ARC4, DES, 3DES) stuff
 */
/* output : output data buffer */
/* input : input data buffer */
/* key : arc4 key data */
/* index_1 : value of index x from ARC4 key structure */
/* index_2 : value of index y from ARC4 key structure */
/* Be carefull : ARC4 key should be expanded before calling this method (Should we provide an expand function ??) */
typedef int t_zencod_arc4_cipher ( KEY *output, const KEY *input, const KEY *key,
