...
*   DESCRIPTION
*
*       This file contains the FTP Client implementation of RMD.
*
*   DATA STRUCTURES
*
*       None
...
*   DESCRIPTION
*
*       This function provides a primitive to send an FTP RMD (remove
...
*       containing the name of the directory to be removed.
*
*   INPUTS
*
