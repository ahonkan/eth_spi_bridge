...
*   DESCRIPTION
*
*       This function creates a new directory on the remote host at the
*       location defined in path. This function is a client-level wrapper for
*       the FCP_Client_MKD() function.  Its sole purpose is to add a caller
