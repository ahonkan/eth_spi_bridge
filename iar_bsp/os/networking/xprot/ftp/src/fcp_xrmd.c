...
*   DESCRIPTION
*
*       This file contains the FTP Client implementation of XRMD.
*
*   DATA STRUCTURES
*
*       None
...
*   DESCRIPTION
*
*       This function provides a primitive to send an FTP XRMD (remove
...
*       string containing the name of the directory to be removed. This
*       function is called by FTP_Client_RMD() if a command not recognized
