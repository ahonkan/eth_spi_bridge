...
*   DESCRIPTION
*
*       This file contains support for Client MKD Response.
*
*   DATA STRUCTURES
*
*       None
...
*   DESCRIPTION
*
*       This function reads the reply from the server for the MKD and XMKD
