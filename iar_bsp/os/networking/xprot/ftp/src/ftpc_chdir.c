...
*   DESCRIPTION
*
*       This function changes the remote current working directory to the path
*       contained in path.  This function is a client-level wrapper for the
*       FCP_Client_CWD() function.  Its sole purpose is to add a caller
*       verification wrapper to the primitive.
*
*   INPUTS
*
*       client                  pointer to valid FTP client structure
*       path                    pointer to character string containing a
*                               remote path
*
*   OUTPUTS
*
