...
*   DESCRIPTION
*
*       This file contains the FTP Client implementation of SYST.
*
*   DATA STRUCTURES
*
*       None
...
*   DESCRIPTION
*
*       This function provides a primitive to send an FTP SYST (system
*       information) message to the server. Parameters include a pointer to a
*       valid FTP client structure, a pointer to a character buffer to store
*       the system information, and the size of the buffer, in bytes.
*
*   INPUTS
*
*       client                  pointer to valid FTP client structure
*       buffer                  pointer to the storage location for system
*                               information
...
INT FCP_Client_SYST(FTP_CLIENT *client, CHAR *buffer, INT buffsize)
{
    ...
    /* Send FTP Command */
    status = (INT)NU_Send(client->socketd,"SYST\r\n",6,0);
