...
*   DESCRIPTION
*
*       This file contains the FTP Client implementation of XCWD.
*
*   DATA STRUCTURES
*
*       None
...
*   DESCRIPTION
*
*       This function provides a primitive to send an FTP XCWD (change working
*       directory, experimental) message to the server. Parameters include a
*       pointer to a valid FTP client structure and a pointer to a character
*       string containing the new working directory path. This function is
*       called by FTP_Client_CWD() if a command not recognized error is
*       returned.  Some servers still use the older experimental version of
*       this command.
*
*   INPUTS
*
...
INT FCP_Client_XCWD(FTP_CLIENT *client, CHAR *path)
{
    ...
    buffer[0] = 'X';  /* Experimental */
    buffer[1] = 'C';  /* Change */
    buffer[2] = 'W';  /* Working */
    buffer[3] = 'D';  /* Directory */
    buffer[4] = ' ';
