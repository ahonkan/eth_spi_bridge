...
*   DESCRIPTION
*
*       This file contains the FTP Client implementation of PORT.
*
*   DATA STRUCTURES
*
*       None
...
*   DESCRIPTION
*
*       This function provides a primitive to send an FTP PORT message to the
...
INT FCP_Client_PORT(FTP_CLIENT *client, struct addr_struct *servaddr)
{
    ...
    /* Store the port in the buffer */
    buffer[index] = ',';
    index++;
    NU_ITOA((INT)(servaddr->port/256), (CHAR*)&buffer[index],10);
