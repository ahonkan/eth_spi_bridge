...
*   DESCRIPTION
*
*       This file contains the FTP Client implementation of DELE.
*
*   DATA STRUCTURES
*
*       None
...
*   DESCRIPTION
*
*       This function provides a primitive to send an FTP DELE message to the
...
*       path                    pointer to character string containing file
*                               to delete
*
*   OUTPUTS
*
