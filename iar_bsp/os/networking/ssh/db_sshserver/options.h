...
#define DROPBEAR_DEFPORT STRINGIFY(CFG_NU_OS_NET_SSH_DB_SSHSERVER_PORT)
#endif

#ifndef DROPBEAR_DEFADDRESS
/* Listen on all interfaces */
#define DROPBEAR_DEFADDRESS CFG_NU_OS_NET_SSH_DB_SSHSERVER_INTERFACE
#endif

/* Default hostkey paths - these can be specified on the command line */
#ifndef DSS_PRIV_FILENAME
#define DSS_PRIV_FILENAME CFG_NU_OS_NET_SSH_DB_SSHSERVER_HOST_KEY_PATH "dropbear_dss_host_key"
#endif
#ifndef RSA_PRIV_FILENAME
#define RSA_PRIV_FILENAME CFG_NU_OS_NET_SSH_DB_SSHSERVER_HOST_KEY_PATH "dropbear_rsa_host_key"
#endif

/* MGC: If set to true convert host key dumps in file dropbear_host_key.c
 * file and write them to file system.*/
#define SSH_INCLUDE_INITIAL_FILES CFG_NU_OS_NET_SSH_DB_SSHSERVER_INCLUDE_INITIAL_FILES

/* MGC: Creates an NU_FAMILY_IP6 socket to listen for IPv4 and IPv6 connections.*/
#define SSH_ENABLE_IPV6 INCLUDE_IPV6
...
#if CFG_NU_OS_NET_SSH_DB_SSHSERVER_RSA_AUTH
#define DROPBEAR_RSA
#endif
#if CFG_NU_OS_NET_SSH_DB_SSHSERVER_DSS_AUTH
#define DROPBEAR_DSS
#endif
