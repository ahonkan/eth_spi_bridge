...
* DESCRIPTION
*
*       This function adds a new SA to the list of outbound SAs. It
*       also enables ESN on the SA.
*
* INPUTS
*
                                 ...
                                 UINT32 *return_index)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                /* Enable ESN. */
                return_sa_ptr->ipsec_seq_num.ipsec_is_esn = NU_TRUE;
