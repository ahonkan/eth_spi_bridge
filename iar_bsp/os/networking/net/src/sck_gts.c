...
*   DESCRIPTION
*
*       This file contains the routine to determine whether TCP Timestamp
*       Option support is set for a socket.
*
*   DATA STRUCTURES
*
*       None.
...
*       *optval                 The value of TCP Timestamp option support
...
STATUS NU_Getsockopt_TCP_TIMESTAMP(INT socketd, UINT8 *optval)
{
	...
	{
		status = TCP_Getsockopt_TCP_TIMESTAMP(socketd, optval);
