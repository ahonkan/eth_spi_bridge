...
*       times to retransmit a data segment before closing the connection
...
*   DESCRIPTION
*
*       API routine to configure the number of times to retransmit a data
...
STATUS NU_Setsockopt_TCP_MAX_R2(INT socketd, UINT8 max_retrans)
{
    ...
    {
        /* Set the value. */
        status = TCP_Setsockopt_TCP_MAX_R2(socketd, max_retrans);
