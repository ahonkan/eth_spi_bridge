...
*   DESCRIPTION
*
*       This file contains the API routine to retrieve the amount of time
...
*   DESCRIPTION
*
*       API routine to retrieve the amount of time to wait before reusing
...
*                               the MSL value to set for the specified
*                               socket.
*
*   OUTPUTS
*
...
STATUS NU_Getsockopt_TCP_MSL(INT socketd, UINT32 *msl)
{
	...
	{
		/* Retrieve the value. */
		status = TCP_Getsockopt_TCP_MSL(socketd, msl);
