...
*   DESCRIPTION
*
*       This file contains the routine to retrieve the value of the
...
*   DESCRIPTION
*
*       Retrieve the value of the maximum retransmission timeout on a TCP
*       socket at run-time.
*
*   INPUTS
*
...
STATUS TCP_Getsockopt_TCP_MAX_RTO(INT socketd, UINT32 *timeout)
{
    ...
    if ( (pindex != NU_IGNORE_VALUE) && (TCP_Ports[pindex] != NU_NULL) )
    {
        ...
        *timeout = TCP_Ports[pindex]->p_max_rto;
