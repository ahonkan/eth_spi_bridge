...
*   DESCRIPTION
*
*       This file contains the routine to get the interface to be used
...
*   DESCRIPTION
*
*       This function gets the broadcast interface of a socket.
*
*   INPUTS
*
...
*
*************************************************************************/
STATUS NU_Getsockopt_IP_BROADCAST_IF(INT socketd, UINT8 *dev_address,
                                     INT *addr_len)
{
    STATUS  status;
    ...
    {
        IP_Getsockopt_IP_BROADCAST_IF(socketd, dev_address, addr_len);
