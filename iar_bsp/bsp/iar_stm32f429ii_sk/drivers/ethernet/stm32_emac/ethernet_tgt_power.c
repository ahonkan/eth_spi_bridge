...
*   FUNCTION
*
*       Ethernet_Tgt_Pwr_Default_State
*
*   DESCRIPTION
*
*       This function sets up the STM32_EMAC hardware
*
*   INPUTS
*
...
STATUS Ethernet_Tgt_Pwr_Set_State(VOID *inst_handle, PM_STATE_ID *state)
{
        ...
        (PMI_STATE_GET(pmi_dev_ptr) == ETHERNET_OFF))
    {
        ...
        if (lm3s_inst_handle->device_in_use == NU_TRUE)
        {
            ...
            pm_status = PMI_Min_OP_Pt_Calc(pmi_dev_ptr, &(lm3s_inst_handle->ref_clock[0]), STM32_EMAC_MIN_FREQUENCY, &min_op_id);
            ...
            {
                /* Enable RX and TX */
                Ethernet_Tgt_Enable(lm3s_inst_handle);
            }                          
        }
